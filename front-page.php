    ...
    <main id="main" class="site-main" itemscope itemtype="http://schema.org/Blog">
        ...
        <div class="col-lg-9 content-area">
            <div class="row featured-content-area clearfix">
                 <div class="col-lg-4">
                    <?php $args = array( 'posts_per_page' => 3, 'cat' => 52 ); query_posts($args); $catstyle1= true; ?>
                    <?php if(have_posts()) : ?>
                        <?php while( have_posts() ) : the_post(); ?>
                 ...
                 <div class="col-lg-4">
                    <?php $args = array( 'posts_per_page' => 3, 'cat' => 53 ); query_posts($args); $catstyle1= true;?>
                    <?php if(have_posts()) : ?>
                        <?php while( have_posts() ) : the_post(); ?>
                                <?php if ($catstyle1 == true) : ?>
                                    <?php get_template_part('templates/content', 'catstyle1a'); ?>
            ...
            <?php $args = array( 'posts_per_page' => 5, 'cat' => 54 ); query_posts($args);?>
            <?php if(have_posts()) : ?>
            <div class="row">
                    <?php while( have_posts() ) : the_post(); ?>
			...
			<?php wp_reset_query(); ?>
            <?php endif; ?>
            <?php $args = array( 'posts_per_page' => 2, 'cat' => 47 ); query_posts($args);?>
            <?php if(have_posts()) : ?>
            <div class="row">
                    <?php while( have_posts() ) : the_post(); ?>
                            <div class="col-lg-12">
