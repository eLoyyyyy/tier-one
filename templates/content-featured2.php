<div class="row">
    <div class="col-lg-12">
        <article class="featured-post2" id="post-<?php the_ID(); ?>" itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
        ...
        <header class="entry-meta site-meta-t" style="display:none;">
            ...
            <time itemprop="dateModified" datetime="<?php the_modified_time('c'); ?>"></time>
        </header>
            <?php 
