<div class="col-lg-9">
    <article class="featured-post" id="post-<?php the_ID(); ?>" itemscope itemtype="http://schema.org/BlogPosting" itemprop="blogPost" >
        ...
        <div class="carousel-caption">
            ...
            <p class="featured-excerpt" itemprop="description"><?php tierone_excerpt('short'); ?></p>
        </div>
    </article>
</div>