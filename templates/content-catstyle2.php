...
<article class="catstyle2-post" id="post-<?php the_ID(); ?>" itemscope itemtype="http://schema.org/BlogPosting">
    ...
    ?>
        ...
        <?php endif; ?>
    <p class="featured-excerpt" itemprop="description"><?php tierone_excerpt(4); ?></p><!--catstyle2-short-->
</article>