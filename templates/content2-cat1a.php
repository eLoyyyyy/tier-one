<article class="cat1a-post" id="post-<?php the_ID(); ?>" itemscope itemtype="http://schema.org/BlogPosting">
    ...
    <div class="caption">
        ...
        <small><?php the_date('D,  M d Y');?> &nbsp;<?php the_author(); ?>, <?php the_category(' &bull; '); ?></small>
    </div>
</article>